...
namespace Ecommerce.Clients.API.Application.Commands
{
    public class AtualizarEnderecoCommand : Command
    {
        ...
        public AtualizarEnderecoCommand()
        {
        }

        public AtualizarEnderecoCommand(Guid clienteId, string logradouro, string numero, string complemento,
        ...
        public class EnderecoValidation : AbstractValidator<AtualizarEnderecoCommand>
        {
